$(document).ready(function () {
    ...
    $('#btnEditarSala').click(function () {
        ...
        let recursos = $('#recursosSalaEditar').val().trim();  // Obtener los recursos
        ...
        formData.append('recursosEditar', recursos);  // Cambiar a 'recursosEditar'
        ...
        $.ajax({
            ...
            contentType: false,
            success: function (response) {
                console.log("Respuesta del servidor:", response);  // Esto imprime la respuesta tal como se recibe
                try {

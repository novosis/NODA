<?php
require_once 'cx.php'; // Incluye el archivo de conexión a la base de datos
...
if (isset($_POST['res'])) {
    ...
    if (isset($_POST['busqueda']) && !empty($_POST['busqueda'])) {
        ...
        $query = "SELECT * FROM usuario WHERE nombre LIKE '%$busqueda%' OR apellido LIKE '%$busqueda%' OR correo LIKE '%$busqueda%' OR cargo LIKE '%$busqueda%'";
    } else {

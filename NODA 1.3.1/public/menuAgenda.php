...
<head>
    ...
    <title>salas de todos los usuarios</title>
    ...
    <link rel="stylesheet" href="../vista/css/style-agendar-salas/style.css">
</head>
<body>
    <div class="Buscador">
    ...
    <div id="formularioAgregarSala" class="formulario-overlay2">
        <div class="formulario-container">
            ...
            <form id="formAgregarSala" enctype="multipart/form-data">
                <label for="imagenSala">Imagen:</label>
                ...
                <label for="capacidadSala">Capacidad de Personas:</label>
                <input type="number" id="capacidadSala" name="capacidad" required><br>

                <label for="recursosSala">Recursos de Sala:</label>

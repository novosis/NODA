            ...
            success: function(data) {
                ...
                if (data.length === 0) {
                    ...
                    data.forEach(function(sala) {
                        Reserva(sala.id, sala.nombre, sala.capacidad, sala.fecha, sala.hora, sala.imagen, sala.insumo, sala.observaciones);
                    });
                }
            },
...
function Reserva(id, nombre, capacidad, fecha, hora, imagen, insumo, observaciones) {
    let reservaHTML = `
